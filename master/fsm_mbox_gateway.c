...
int mbox_type_to_prot(uint8_t mbox_type, uint8_t *mbox_prot)
{
    switch (mbox_type)
    {
    case EC_MBOX_TYPE_AOE:
    {
        *mbox_prot = EC_MBOX_AOE;
    }
    break;
    case EC_MBOX_TYPE_EOE:
    {
        *mbox_prot = EC_MBOX_EOE;
    }
    break;
    case EC_MBOX_TYPE_COE:
    {
        *mbox_prot = EC_MBOX_COE;
    }
    break;
    case EC_MBOX_TYPE_FOE:
    {
        *mbox_prot = EC_MBOX_FOE;
    }
    break;
    case EC_MBOX_TYPE_SOE:
    {
        *mbox_prot = EC_MBOX_SOE;
    }
    break;
    case EC_MBOX_TYPE_VOE:
    {
        *mbox_prot = EC_MBOX_VOE;
    }
    break;
    default:
    {
...
)
{
    ...
    if (fsm->datagram->working_counter != 1)
    {
        ...
        EC_SLAVE_ERR(slave, "Reception of MBox Gateway request"
                            " failed with timeout after %lu ms: ",
                     diff_ms);
